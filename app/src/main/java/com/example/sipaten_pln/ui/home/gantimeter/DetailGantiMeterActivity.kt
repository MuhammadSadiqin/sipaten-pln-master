...
import com.example.sipaten_pln.ui.home.detailgantimeter.DetailGantiMeterPresenter
...
class DetailGantiMeterActivity : AppCompatActivity(),DetailGantiMeterContract.View {
    private lateinit var presenter: DetailGantiMeterPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detail_ganti_meter)

        // Buat instance presenter
        presenter = DetailGantiMeterPresenter(this)
        ...
        btnSave.setOnClickListener {
            ...
            presenter.updateGantiMeter(data.id, data)
    ...
    override fun onUpdateSuccess(response: GantiMeterResponse) {
        Toast.makeText(this, "Update successful", Toast.LENGTH_SHORT).show()

        finish()
        val detail = Intent(this, GantiMeterActivity::class.java)
