...
object Helpers {
    ...
    fun TextView.formatPrice(value : String){
        this.text = getCurrecyIDR(java.lang.Double.parseDouble(value))
    }
    fun getCurrecyIDR (price : Double) : String{
    ...
    fun getDefaultGson() : Gson {
        return GsonBuilder()
            ...
            .registerTypeAdapter(Date::class.java, JsonDeserializer{ json, _, _, ->
                val formatServer = SimpleDateFormat("yyy-MM-dd'T'HH:mm:ss.SSS'z'", Locale.ENGLISH)
